  ...
  return (
    ...
    <Table.Row>
      ...
      <div>
        ...
        {/* Topic: Confirming Cabin Deletions (1) */}
        <Modal>
          ...
          <Modal.Window name="delete">
            {/* NOTE Modal is closed without calling 'onCloseModal' from Modal.Window bcs the row is deleted, so the modal disappears too.*/}
            <ConfirmDelete
              resourceName="cabins"
              disabled={isDeleting}
