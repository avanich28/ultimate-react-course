...
// Topic: Splitting Components in Practice

// Structural Component - only responsible for the structure or for the layout of application
export default function App() {
  const [movies, setMovies] = useState(tempMovieData);
  const [watched, setWatched] = useState(tempWatchedData);

  return (
    // Using Component Composition technique 😎
    <>
      <NavBar>
        {/* 🍀 */}
        <Search />
...
// Topic: Fixing Prop Drilling With Composition (And Building a Layout) 🍀
...
// Presentational component - doesn't have any state
function Logo() {
  // Can create more components ex. icon and title, but it is too much
  return (
    <div className="logo">
      <span role="img">🍿</span>
      <h1>usePopcorn</h1>
...
// Stateful Component
// Topic: Using Composition to Make a Reuseable Box
// 🚀 children preferred than element
...
// Topic: How to Split a UI Into Components
// In slide
